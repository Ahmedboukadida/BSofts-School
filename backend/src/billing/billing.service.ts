  ...
  async getPlatformConfig(user?: any) {
    ...
    if (!user?.isRoot) {
      return {
        ...
        stripeCurrency: config.stripeCurrency || config.currency || 'TND',
        stripeTestMode: config.stripeTestMode,
        clicToPayEnabled: config.clicToPayEnabled,
        clicToPayTestMode: config.clicToPayTestMode,
        clicToPayCurrency: config.clicToPayCurrency || config.currency || 'TND',
